"""Network Security Group (NSG) building block for CloudSpells.
...
from providers.oci.network import SUBNET_MANAGEMENT, SUBNET_PRIVATE, SUBNET_PUBLIC, SUBNET_SECURE, Vcn, VcnRef
